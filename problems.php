...
<div dir="<?php echo $dir; ?>"><h2> <span class="<?php echo $float; ?>"><i class="far fa-file-alt"></i><?php echo "Problems"; ?></span>
...
<table class="example" id="example">
 ...
 <th><?php echo "Time of problem"; ?></th>
...
<tr>
    ...
    echo $row_dataset['issueCustDescription'];

     ?></td>

      <td><?php  echo $row_dataset['issueTime'];  ?></td>
    <td>
...
<?php // if(substr($row_permission['SupportFiles_access_level'],2,-2)  == '1' || $row_isadmin['IsAdmin'] == '1'){  ?>
    <a href="viewproblem.php?culture=<?php echo $culture; ?>&id=<?php echo $row_dataset['ID']; ?>" class="btn btn-outline-success"><i class="fa fa-eye"></i></a>
