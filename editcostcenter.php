...
$tsql = "UPDATE LASCostCentersgrp  SET 
          Code = (?),
          AName = (?),
          EName= (?),
          GroupID= (?),
...
sqlsrv_close($connSelComp);  
  ...
  $updateGoTo = "editcostcenter.php?id=".$Id;
  if (isset($_SERVER['QUERY_STRING'])) {
    $updateGoTo .= (strpos($updateGoTo, '?')) ? "&" : "?";
    $updateGoTo .= $_SERVER['QUERY_STRING'];
  }
   header(sprintf("Location: editcostcenter.php?id=".$Id, $insertGoTo));
}
...
$StrSql = "Select * from LASCostCentersgrp WHERE ID = '".$_GET['id']."'";
...
if($row_costcenter['IsGroup'] == 1){
 echo "<a href='createcostcenter.php?id=".$row_costcenter['ID']."&GroupID=".$newgroupid."' class='btn btn-primary col-md-4 float-left' >Add New</a>"; }
...
<a href="editcostcenter.php?id=<?php echo $row_costcenter['ID']; ?>" class="btn btn-success col-md-4 float-right" >Edit</a>
...
<div class="col-md-8 float-right">
 ...
 <div class="heading">
  ...
  <h3 class="col-md-10"> <span class="glyphicon glyphicon-pencil"></span> Edit Cost Center Information  </h3> 
...
<div class="">
    ...
    <form method="post" name="form1" action="editcostcenter.php">

<div class="col-md-2">Code</div>
<div class="col-md-10"><input type="text" name="Code" class="form-control" value="<?php echo $row_costcenter['Code']; ?>" /></div>

<div class="col-md-12"><br></div>

<div class="col-md-2">Name (Arabic)</div>
<div class="col-md-10"><input type="text" name="AName" class="form-control" value="<?php echo $row_costcenter['AName']; ?>" /></div>

<div class="col-md-12"><br></div>

<div class="col-md-2">Name (English)</div>
<div class="col-md-10"><input type="text" name="EName" class="form-control"  value="<?php echo $row_costcenter['EName']; ?>" /></div>
...
<div class="col-md-10">
<select name="GroupID" id="GroupID" class="form-control" onchange="getData();"  value="<?php echo $row_costcenter['GroupID']; ?>" >
...
$sql1 = "SELECT 1 AS ID, 'COMP' AS Code, '".$row_compname['compNameEn']."' AS EName, '1' AS IsGroup, '1' AS IsActive
UNION
...
<div class="col-md-4"><br></div>
 ...
 <input type="submit" id="addbtn" value="Edit Cost Center" class="col-md-2 btn btn-primary col-xs-offset-1">
