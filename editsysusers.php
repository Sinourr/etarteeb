...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
 ...
 $PhoneNumberConfirmed = $_POST['PhoneNumberConfirmed'];
 $TwoFactorEnabled = $_POST['TwoFactorEnabled'];
 $LockoutEnabled = $_POST['LockoutEnabled'];
 $AccessFailedCount = $_POST['AccessFailedCount'];
...
$params = array($CompanyId, $companyCode, $nameEnglish, $nameArabic,  $isAdmin, $isActive, $AddedBy, $AddedDate, $EmployeeId, $PasswordHash, $PhoneNumber, $PhoneNumberConfirmed, $TwoFactorEnabled, $LockoutEnabled, $AccessFailedCount, $UserName, $Role, $CreatedFrom, $Id);
...
<h2>Edit System Users <a href="masterusers.php?culture=en" class="btn btn-outline-primary" style="">Go Back</a>
 </h2>
...
<input type="text" name="nameEnglish" id="nameEnglish" required class="form-control" value="<?php echo $row_edituser['nameEnglish']; ?>">
   ...
   <div class="col-md-1"><label>Role:</label></div>
       ...
       <div class="col-md-3"><select name="Role"id="Role" class="form-control js-example-basic-single dropdownn" required >
              ...
              <?php while ($row_role = sqlsrv_fetch_array( $stmt12, SQLSRV_FETCH_ASSOC)){ ?>
          

            <option value="<?php echo 'Owner'; ?>" <?php if (!(strcmp('Owner', htmlentities($row_role['Role'], ENT_COMPAT, '')))) {echo "SELECTED";} ?>><?php echo 'Owner'; ?></option>
...
<div class="row">
        <div class="col-md-2"><label>Is Admin:&nbsp;</label><input type="checkbox" name="isAdmin" value="1" size="32" id="isAdmin" autocomplete="off" <?php if($row_edituser['isAdmin'] == 1){echo "Checked";}else{} ?> ></div>
   ...
   <div class="col-md-2"><label>Is Active: &nbsp;</label><input type="checkbox" name="isActive" value="1" size="32" id="isActive"  autocomplete="off" <?php if($row_edituser['isActive'] == 1){echo "Checked";}else{} ?> ></div>
    ...
    <div class="col-md-12">
     ...
     <a href='addsysuser.php' class='col-md-2 col-xs-offset-1 btn btn-success'>Add User</a>
