...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
 ...
 $tsql= "INSERT INTO dbo.LASCostCentersgrp (
  ...
  $insertGoTo = "Ccenter.php?id=".$_GET['id'];
  if (isset($_SERVER['QUERY_STRING'])) {
    $insertGoTo .= (strpos($insertGoTo, '?')) ? "&" : "?";
    $insertGoTo .= $_SERVER['QUERY_STRING'];
  }
  header(sprintf("Location: Ccenter.php?id=".$_GET['id'], $insertGoTo));
}
...
<div class="container col-md-8 float-right">
	...
	<div class="heading">
		...
		<h3 class="col-md-8"> Add Cost Center Information  </h3> 
...
<div class="">
    ...
    <form method="post" name="form1" action="createcostcenter.php">
...
<div class="col-md-4"></div>
 ...
 <input type="submit" id="addbtn" value="Add Cost Center" class="col-md-2 btn btn-primary col-xs-offset-1" tabindex="8" >
