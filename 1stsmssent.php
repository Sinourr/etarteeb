...
$StrSql1 = "Select COUNT(*)-1 as count from Orders WHERE IsOpen=1";
...
<br>
  ...
  <div class="card-body">
    <p class="card-text">Dear Customer. Thanks for ordering from US. Your order was received at <?php echo $row_data['TimeofOrder']; ?>. And you have <?php echo $row_custcount['count']; ?> customers waiting in line before you. </p>
    <p>If you are facing any problem with our service please follow the link below:
    	<br>
    <a href="problem.php?id=<?php echo $_GET['id']; ?>">Help!</a>
  </div>
</div>
