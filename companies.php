...
<div><h2><i class="far fa-file-alt"></i> Companies Information

 <a href='addcomp.php' class='btn btn-outline-primary float-right' >Add</a>
</h2>
...
<tr>
    ...
    <td><?php echo $row_dataset['EName']; ?></td>
   <td><?php echo $row_dataset['Email']; ?></td>
   <td><?php echo $row_dataset['TelNo1']; ?></td>
   <td><?php  ?></td>
