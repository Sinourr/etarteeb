...
<div><h2><i class="far fa-file-alt"></i> Orders

 <a href='dashboard.php' class='btn btn-outline-primary float-right' >Add</a>
</h2>
...
<tr>
    ...
    <td><?php echo $row_dataset['CustMobile']; ?></td>
   <td><?php if($row_dataset['IsOpen'] == '1'){echo "Open";} else {echo "Closed";} ?></td>
   <td><?php echo $row_dataset['TimeofOrder']; ?></td>
   <td><?php 
...
$start_tt = new DateTime($row_dataset['TimeofOrder']);
$current_tt = new DateTime(date("h:i:s a"));
$differencet =  $current_tt  ->diff($start_tt);
$return_timet = $differencet ->format('%H:%I:%S');




   if($row_dataset['IsOpen'] == '0'){
    echo $return_time; 
  }else{
    echo $return_timet;
   ...
   ?></td>
    ...
    <td><a href="editorder.php?id=<?php echo $row_dataset['ID']; ?>" class="btn btn-outline-primary"><i class="far fa-edit"></i></a>
