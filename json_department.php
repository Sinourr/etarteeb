...
$sql = "SELECT 1 AS ID, NullIf('null', 'null') AS GroupID, '".$title."'  AS title,'Department.php?id=1' AS href, 
1 AS folder, 'mainhead' AS extraClasses, 
'mainicon' AS icon
UNION
SELECT ID, GroupID, EName AS title, CONCAT('Department.php?id=', ID) AS href, 
