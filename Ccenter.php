...
if($row_costcenter['IsGroup'] == 1){
 ...
 echo "<a href='createcostcenter.php?id=".$row_costcenter['ID']."&GroupID=1' class='btn btn-primary col-md-4 float-left' >Add New</a>";
}
...
<a href="editcostcenter.php?id=<?php echo $row_costcenter['ID']; ?>" class="btn btn-success col-md-4 float-right <?php if($_GET['id'] == 1){echo "disabled";} ?>"  >Edit</a>
...
<div class="col-md-8 float-right">
 ...
 <div class="heading">
  ...
  <h3 class="col-md-10"> Cost Center Information  </h3> 
