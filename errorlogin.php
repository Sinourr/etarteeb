...
if (isset($_POST['username']))
 ...
 if($_POST['ccompanylst'] == 'db0' & $_POST['username'] == "owner" & $_POST['Password'] == 'User100+'){
    ...
    header("Location: dashboard.php?SpecialsessionId=".date("sihs"));
...
header("Location: errorloging.php");
			...
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<div class="login100-form validate-form p-b-33 p-t-5">
					...
					<center>
						...
						<span class="text-danger">Incorrect username or password. Please try again</span>
