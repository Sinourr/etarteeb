...
sqlsrv_close($connSelComp);  
  ...
  $updateGoTo = "editdepartment.php?id=".$Id;
  if (isset($_SERVER['QUERY_STRING'])) {
    $updateGoTo .= (strpos($updateGoTo, '?')) ? "&" : "?";
    $updateGoTo .= $_SERVER['QUERY_STRING'];
  }
   header(sprintf("Location: editdepartment.php?id=".$Id, $insertGoTo));
}
...
<a href="editdepartment.php?id=<?php echo $row_costcenter['ID']; ?>" class="btn btn-success col-md-4 float-right" >Edit</a>
...
<div class="col-md-8 float-right">
 ...
 <div class="heading">
  ...
  <h3 class="col-md-10"> <span class="glyphicon glyphicon-pencil"></span> Edit Department Information  </h3> 
...
<div class="">
    ...
    <form method="post" name="form1" action="editdepartment.php">
...
<div class="col-md-4"><br></div>
 ...
 <input type="submit" id="addbtn" value="Edit Department" class="col-md-2 btn btn-primary col-xs-offset-1">
...
persist: {
  ...
  lazyLoad: function(event, data) {
    data.result = {url: "json_department.php"};
...
function getData() {
  ...
  if(GroupID != '') {
    $.ajax({
      type : "get",
      dataType: "json",
      url: "getdepartcode.php?GroupID="+GroupID,
