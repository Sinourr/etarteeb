...
<h2>System Users <a href="addsysuser.php" class="btn btn-outline-primary float-right" style="float:right">Add User</a>
 </h2>
  ...
  <?php
   ...
   while( $row_users = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
    ...
    <tr>
      ...
      <td><?php echo $row_users['EmployeeId']; ?></td>
      <td><?php echo $row_users['nameEnglish'];  ?></td>
