...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
 ...
 $LockoutEndDateUtc = $_POST['LockoutEndDateUtc'];
 ...
 $tsql= "INSERT INTO dbo.AspNetUsers (
  ...
  $insertGoTo = "editsysusers.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    $insertGoTo .= (strpos($insertGoTo, '?')) ? "&" : "?";
    $insertGoTo .= $_SERVER['QUERY_STRING'];
  }
  header(sprintf("Location: editsysusers.php?emp_id=".$Id."&empcode=".$EmployeeId, $insertGoTo));
}
...
<head>
   <title>Online Accounting System</title>
...
<h2>Add System Users <a href="masterusers.php?culture=en" class="btn btn-outline-primary" style="">Go Back</a>
 </h2>
